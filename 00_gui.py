...
col_image = [[sg.Text('----', key='-CHOIXPROFILE-')],
    ...
    [sg.Text('Angle de rotation (degrés, sens trigonométrique)'), sg.Input(0, key='-ANGLEROT-', size=(10,1))],
...
col_IPN = [[sg.Text('d, hauteur'), sg.Input(key='-HAUTEUR-', size=(10,1))],
    [sg.Text('b, largeur'), sg.Input(size=(10,1))],
    [sg.Text('t_f, épaisseur de l\'aile'), sg.Input(size=(10,1))],
    [sg.Text('t_w, épaisseur de l\'ame'), sg.Input(size=(10,1))],
    [sg.Text('r_r, rayon en racine'), sg.Input(size=(10,1))],
    [sg.Text('r_f, rayon de l\'aile'), sg.Input(size=(10,1))],
    [sg.Text('alpha, angle en degrés de l\'aile'), sg.Input(size=(10,1))],
    [sg.Text('n_r, nombre de points de discrétisation des rayons'), sg.Input(size=(10,1))]
    ]

col_IPE = [[sg.Text('d, hauteur'), sg.Input(key='-HAUTEUR-', size=(10,1))],
    [sg.Text('b, largeur'), sg.Input(size=(10,1))],
    [sg.Text('t_f, épaisseur de l\'aile'), sg.Input(size=(10,1))],
    [sg.Text('t_w, épaisseur de l\'ame'), sg.Input(size=(10,1))],
    [sg.Text('r, rayon en racine'), sg.Input(size=(10,1))],
    [sg.Text('n_r, nombre de points de discrétisation du rayon'), sg.Input(size=(10,1))]
    ]

col_UPN = [[sg.Text('d, hauteur'), sg.Input(key='-HAUTEUR-', size=(10,1))],
    [sg.Text('b, largeur'), sg.Input(size=(10,1))],
    [sg.Text('t_f, épaisseur de l\'aile'), sg.Input(size=(10,1))],
    [sg.Text('t_w, épaisseur de l\'ame'), sg.Input(size=(10,1))],
    [sg.Text('r_r, rayon en racine'), sg.Input(size=(10,1))],
